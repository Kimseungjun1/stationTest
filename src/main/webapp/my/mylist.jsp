...
<body>
	...
	<div class="divright">
		...
		<h2><%=mname%>님의 마이페이지</h2>
		
		<form action = "mymodify.jsp" method="post">
	...
	<div class="divleft">
		...
		<%} %>
	 	...
	 	<table class="menuleft">
	 		...
	 		<tr>
	 			<td><a href="#" onclick="mdelete()">회원탈퇴</a></td>
	 		</tr>
	 		 <%
	 		 	}
	 		 %>
	...
	function mdelete(){
		...
		YN = confirm("정말로 회원탈퇴하시겠습니까?");
		if(YN){
			
			location.href = 'delete.jsp?midx=<%=login.getMidx()%>';
			
		}else{
			location.href = 'mycheck.jsp';
		}
	}
	</script>
